...
QUnit.module('Int64');
  ...
  QUnit.test('Int64', function(assert) {
    ...
    const EXPECTED_SMALL_INT64 = BigInt(42);
    const EXPECTED_MAX_JS_SAFE_INT64 = BigInt(Number.MAX_SAFE_INTEGER);
    const EXPECTED_MIN_JS_SAFE_INT64 = BigInt(Number.MIN_SAFE_INTEGER);
    const EXPECTED_MAX_JS_SAFE_PLUS_ONE_INT64 = BigInt("0020000000000000"); // hex-encoded
    const EXPECTED_MIN_JS_SAFE_MINUS_ONE_INT64 = BigInt("ffe0000000000000"); // hex-encoded 2's complement
    const EXPECTED_MAX_SIGNED_INT64 = BigInt("7fffffffffffffff"); // hex-encoded
    const EXPECTED_MIN_SIGNED_INT64 = BigInt("8000000000000000"); // hex-encoded 2's complement
